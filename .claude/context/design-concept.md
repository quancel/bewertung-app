...
**Stand: noch nicht befüllt.** Der `design-concept`-Agent legt das Konzept
beim ersten UI-Paket an. Da es keine bestehende Codebasis gibt, entsteht es
als Neuentwurf und startet mit `Herkunft: neu entworfen — Bestätigung
ausstehend`, bis die Markenfragen beim Nutzer beantwortet sind.
